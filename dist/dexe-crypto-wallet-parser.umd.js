(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('web3'), require('bottleneck'), require('lodash'), require('bignumber.js'), require('moment'), require('graphql-request'), require('ioredis'), require('shorthash2'), require('axios'), require('qs')) :
    typeof define === 'function' && define.amd ? define(['exports', 'web3', 'bottleneck', 'lodash', 'bignumber.js', 'moment', 'graphql-request', 'ioredis', 'shorthash2', 'axios', 'qs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.dexeCryptoWalletParser = {}, global.Web3, global.Bottleneck, global.lodash, global.BigNumber, global.moment, global.graphqlRequest, global.IORedis, global.shortHash, global.Axios, global.qs));
}(this, (function (exports, Web3, Bottleneck, lodash, BigNumber, moment, graphqlRequest, IORedis, shortHash, Axios, qs) { 'use strict';
    ...
    ***************************************************************************** */
                                            ...
                                            case 1:
                                                ...
                                                try {
                                                    for (_a = __values(Object.keys(value.balance)), _b = _a.next(); !_b.done; _b = _a.next()) {
                                                        ...
                                                        valueCopy.balance[key].amount.isLessThan(0) ? new BigNumber__default['default'](0) : valueCopy.balance[key].amount, +valueCopy.balance[key].decimals).multipliedBy(uniswapResultFirst.ethPer1Token);
                                                        valueCopy.balance[key].amountInUSD = buildBalanceTransformer(valueCopy.balance[key].amount.isLessThan(0) ? new BigNumber__default['default'](0) : valueCopy.balance[key].amount, +valueCopy.balance[key].decimals).multipliedBy(uniswapResultFirst.usdPer1Token);
                                                    }
                                                }
    ...
    var CalculateBalance = /** @class */ (function () {
        ...
        CalculateBalance.prototype.balanceLookup = function (data, previousBalance, wallet) {
            ...
            var result = Object.keys(data).reduce(function (accum, value) {
                ...
                return accum;
            }, { balance: __assign({}, localPreviousBalance), feeInETH: new BigNumber__default['default'](0), blockNumber: 0, hash: '0', timeStamp: '0' });
            // Minus Fee Operation
    ...
    var UniswapCacheService = /** @class */ (function () {
        function UniswapCacheService(config) {
            this.redis = new IORedis__default['default'](config.env.uniswapCacheRedisURL);
        }
    ...
    var UniswapServiceApi = /** @class */ (function (_super) {
        ...
        function UniswapServiceApi(config) {
            ...
            _this.limiter = new Bottleneck__default['default']({
                ...
                Redis: IORedis__default['default'],
            });
...
//# sourceMappingURL=dexe-crypto-wallet-parser.umd.js.map

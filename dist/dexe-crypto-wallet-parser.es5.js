...
var generateTokenAdressPriceArr = function (data) {
    return lodash.uniq(__spreadArray(__spreadArray([], __read(Object.keys(data.balancesBeforeTransaction).filter(function (token) {
                        ...
                        try {
                            for (_a = __values(Object.keys(value_1.balance)), _b = _a.next(); !_b.done; _b = _a.next()) {
                                ...
                                if (value_1.balance[key].amount.isGreaterThanOrEqualTo(0)) {
                                    ...
                                    value_1.balance[key].ethPer1Token = new BigNumber(0);
                                    value_1.balance[key].usdPer1Token = new BigNumber(0);
                                    value_1.balance[key].usdPer1ETH = new BigNumber(0);
                                    value_1.balance[key].amountInETH = new BigNumber(0);
                                    value_1.balance[key].amountInUSD = new BigNumber(0);
                                }
                            }
                        }
                            ...
                            try {
                                for (_c = __values(Object.keys(value_1.balanceBeforeTransaction)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                    ...
                                    if (value_1.balanceBeforeTransaction[key].amount.isGreaterThan(0)) {
                                        ...
                                        value_1.balanceBeforeTransaction[key].ethPer1Token = new BigNumber(0);
                                        value_1.balanceBeforeTransaction[key].usdPer1Token = new BigNumber(0);
                                        value_1.balanceBeforeTransaction[key].usdPer1ETH = new BigNumber(0);
                                        value_1.balanceBeforeTransaction[key].amountInETH = new BigNumber(0);
                                        value_1.balanceBeforeTransaction[key].amountInUSD = new BigNumber(0);
                                    }
                                }
                            }
    ...
    TradesBuilderV2.prototype.calculateOutgoingEvent = function (accumulatorValue, operation, stateBase, currentItem) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        openTradeIndex = (((_a = accumulatorValue[operation.address]) === null || _a === void 0 ? void 0 : _a.trades) || []).findIndex(function (x) { return x.tradeStatus === TradeStatus.OPEN; });
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (accumulatorValue[operation.address]) {
                            openTradeIndex = accumulatorValue[operation.address].trades.findIndex(function (x) { return x.tradeStatus === TradeStatus.OPEN; });
                            if (openTradeIndex >= 0) {
                                this.calculateOperationWithOpenTrade(operation, stateParsed, accumulatorValue[operation.address], openTradeIndex, currentItemParsed.balanceBeforeTransaction);
                            }
                            else {
...
var TradesBuilderV2Prebuild = /** @class */ (function () {
    ...
    TradesBuilderV2Prebuild.prototype.createNewTradeEvent = function (state, operation, balanceBeforeTransaction, trade) {
        var startDep = { amountInETH: new BigNumber(0), amountInUSD: new BigNumber(0) };
        var tokenInfo = this.createTokenInfo(operation);
        var tradeType = this.tradeTypeSwitcher(operation.amount);
        var price = {
            raw: {
...
var ParserBase = /** @class */ (function () {
    function ParserBase(services, config) {
        ...
        this.uniswapRequestCount = this.services.uniswapService.requestCounter.asObservable().pipe(auditTime(1000));
        this.estimatedUniswapRequests = new BehaviorSubject(0);
...
var UniswapServiceBase = /** @class */ (function () {
    function UniswapServiceBase() {
        this.requestCounter = new BehaviorSubject(0);
    }

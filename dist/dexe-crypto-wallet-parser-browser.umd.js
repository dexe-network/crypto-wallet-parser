(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('web3'), require('bottleneck'), require('lodash'), require('bignumber.js'), require('moment'), require('graphql-request'), require('axios'), require('qs')) :
    typeof define === 'function' && define.amd ? define(['exports', 'web3', 'bottleneck', 'lodash', 'bignumber.js', 'moment', 'graphql-request', 'axios', 'qs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['dexeCryptoWalletParser-browser'] = {}, global.Web3, global.Bottleneck, global.lodash, global.BigNumber, global.moment, global.graphqlRequest, global.Axios, global.qs));
}(this, (function (exports, Web3, Bottleneck, lodash, BigNumber, moment, graphqlRequest, Axios, qs) { 'use strict';

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('web3'), require('bottleneck'), require('lodash'), require('bignumber.js'), require('moment'), require('rxjs'), require('rxjs/operators'), require('graphql-request'), require('axios'), require('qs')) :
    typeof define === 'function' && define.amd ? define(['exports', 'web3', 'bottleneck', 'lodash', 'bignumber.js', 'moment', 'rxjs', 'rxjs/operators', 'graphql-request', 'axios', 'qs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['dexeCryptoWalletParser-browser'] = {}, global.Web3, global.Bottleneck, global.lodash, global.BigNumber, global.moment, global.rxjs, global.operators, global.graphqlRequest, global.Axios, global.qs));
}(this, (function (exports, Web3, Bottleneck, lodash, BigNumber, moment, rxjs, operators, graphqlRequest, Axios, qs) { 'use strict';
